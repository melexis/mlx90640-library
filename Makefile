...
examples: test rawrgb step fbuf interp video
...
examples/rawrgb.o examples/test.o examples/step.o examples/fbuf.o examples/interp.o examples/video.o : CXXFLAGS+=-std=c++11

rawrgb test step fbuf interp video hotspot : CXXFLAGS+=-I. -std=c++11
